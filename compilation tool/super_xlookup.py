...
class SuperXlookup:
    ...
    def run(self) -> None:
        ...
        # Statistiques
        matched = df_source[result_col_name].ne(" ").sum()
        total = len(df_source)
...
if __name__ == "__main__":
    ...
    xl2 = SuperXlookup(
        source_file_path="inputs/Book1.xlsx",
        target_file_path=r"C:\Users\f50056342\Desktop\computer science\NUR Project Lyne\inputs\OCM RAN INCIDENT FOLOW-UP 11-05-2026 18H UTC.xlsx",
        source_key_column="B",
        target_key_column="D",
        target_value_column="J",
        result_position_column="last_free",
        result_column_name="OCM RAN 11-05-2026 18h",
        source_sheet_name="Sheet1",
        target_sheet_name="ALL SITES DOWN"
    )
    xl2.run()
